 ...
 * @param optional nil or *PostSmContextsOpts - Optional Parameters:
 * @param "InlineObject" (optional.Interface of InlineObject) - 
@return SmContextCreatedData
*/

type PostSmContextsOpts struct {
	InlineObject optional.Interface
}

func (a *SMContextsCollectionApiService) PostSmContexts(ctx context.Context, localVarOptionals *PostSmContextsOpts) (SmContextCreatedData, *http.Response, error) {
	var (
