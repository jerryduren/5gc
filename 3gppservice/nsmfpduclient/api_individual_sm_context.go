...
*/
func (a *IndividualSMContextApiService) UpdateSmContext(ctx context.Context, smContextUpdateData SmContextUpdateData, smContextRef string) (SmContextUpdatedData, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
