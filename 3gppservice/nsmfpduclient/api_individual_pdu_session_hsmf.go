...
*/
func (a *IndividualPDUSessionHSMFApiService) UpdatePduSession(ctx context.Context, hsmfUpdateData HsmfUpdateData, pduSessionRef string) (HsmfUpdatedData, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
